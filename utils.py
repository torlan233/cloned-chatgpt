...
def generator_script(subject, video_length, creativity, api_key):
    ...
    model = ChatOpenAI(openai_api_key=api_key,temperature=creativity,
                       openai_api_base = "https://api.aihao123.cn/luomacode-api/open-api/v1")
...
#print(generator_script("sora模型",0.5,0.7, os.getenv("OPENAI_API_KEY")))
